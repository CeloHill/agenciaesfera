    ...
    <div class="footer-content">
      ...
      <div class="footer-section">
        <div class="navigation">
          <div class="nav-item"><NuxtLink to="/sobre" class="nav-item-text">Conheça a Esfera</NuxtLink></div>
          <div class="nav-item"><NuxtLink to="/projetos" class="nav-item-text">Paixão por fazer</NuxtLink></div>
          <div class="nav-item"><NuxtLink to="/contatos" class="nav-item-text">Let's talk</NuxtLink></div>
        </div>
      </div>
    </div>
